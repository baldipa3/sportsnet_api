defmodule SportsnetApi.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    belongs_to :default_sport, SportsnetApi.Sports.Sport
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, SportsnetApi.Repo)
  ...
  """
  def valid_password?(%SportsnetApi.Accounts.User{hashed_password: hashed_password}, password)
